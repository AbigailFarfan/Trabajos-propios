...
def movimiento():
    ...
    if posicion_food == posicion_snake[0]:
        ...
        mixer.music.load("audio snake.mp3")
...
# Vinculamos las teclas de flecha
...
# Vinculamos las teclas W, A, S, D
ventana.bind("<KeyPress-w>", lambda event: direccion('up'))
ventana.bind("<KeyPress-s>", lambda event: direccion('down'))
ventana.bind("<KeyPress-a>", lambda event: direccion('left'))
ventana.bind("<KeyPress-d>", lambda event: direccion('right'))
